  ...
  return (
    <RoleGuard allowedRoles={["admin"]} fallbackUrl="/">
      ...
      >
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Alerts & Logs</h1>
          <p className="text-gray-600 dark:text-gray-400">System alerts and event logs - Admin Only</p>
        </div>
        ...
        <div className="flex items-center justify-center h-96 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Alerts & Logs</h3>
